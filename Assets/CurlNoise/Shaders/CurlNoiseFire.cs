...
namespace CurlNoise {
    public class CurlNoiseFire : MonoBehaviour {
        ...
        [SerializeField] protected float convergencyFrequency = 3f;
        [SerializeField] protected float convergencyFrequencyDistance = 4f;
        ...
        void Update() {
            ...
            compute.SetFloat(CSPARAM.CONVERGENCY, convergency + Mathf.PerlinNoise(timer * convergencyFrequency, Mathf.PingPong(timer * convergencyFrequency, 1.0f)) * convergencyFrequencyDistance);
