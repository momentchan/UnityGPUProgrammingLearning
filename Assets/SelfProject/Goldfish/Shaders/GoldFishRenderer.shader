Shader "Unlit/GoldfishRenderer"
{
    Properties
    {
        ...
        SubShader
        {
            ...
            CGPROGRAM
            #include "../../../Common/Libs/Utils.cginc"
            ...
            void vert(inout appdata_full v)
            {
                ...
                float seed = nrand(float2(unity_InstanceID, 0));

                object2world._11_22_33_44 = float4(scl.xyz, 1);
                object2world = mul(rotMatrix, object2world);
                object2world._14_24_34 += pos.xyz;
                object2world._14_24_34 += float3(0, sin(seed + v.vertex.z * 1000 + _Time.z * 10) * 0.04 * seed,0);
